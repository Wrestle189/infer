...
if __name__ == "__main__":
    ...
    onnx_file_path="/vodla_workload/"+model_name+"/models/bertsquad-10.onnx"
    input_file="/vodla_workload/"+model_name+"/data/input_ids_0.txt"
    ...
    for i in range(num_inferences):
        ...
        outputs=inference_with_tensorrt(engine_file_path, input_data)
