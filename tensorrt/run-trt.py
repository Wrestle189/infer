...
if __name__ == "__main__":
    engine_file_path = "/code/engine.trt"
    onnx_file_path="/resnet18/models/resnet18-v2-7.onnx"
    input_file="/resnet18/data/data_input.txt"

    batch_size=100
    num_inferences = 100  # 假设您要进行10次推理
