...
options.execution_order = rt.ExecutionOrder.PRIORITY_BASED
options.enable_cuda = True  # 指定使用GPU
session = rt.InferenceSession(model_path, sess_options=options)
